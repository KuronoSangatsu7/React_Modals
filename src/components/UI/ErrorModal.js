  ...
  return (
    <div className="fixed inset-0 bg-zinc-300/5 z-10 backdrop-blur-sm flex transition duration-500">
      <div className="m-auto w-2/3 md:w-2/5 backdropdrop-shadow-lg">
        <div className="bg-gradient-to-l from-emerald-700 to-slate-900 rounded-t-md text-2xl p-2 text-white font-medium">
          {props.title}
        </div>
        <div className="bg-zinc-300/60 backdrop-blur-sm rounded-b-md">
